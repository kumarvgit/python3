...
def colour_print(text: str, *effects: str) -> None:
    """
    Print the `text` using ANSI sequences to change colour

    :param text: The text to print
    :param effects: the colour of the text
    :return: None
    """
    effect_str = "".join(effects)
    print(effect_str, text, RESET)


colorama.init()
colour_print("Hello, Red", RED)
# Sending variable arguments to a function
